...
parser.add_argument('--bs', default='12')
parser.add_argument('--n_epochs', type=int, default='100')
parser.add_argument('--patch', default='4', type=int)
parser.add_argument('--cos', action='store_true', help='Train with cosine annealing scheduling')
parser.add_argument('--use_attention_entropy', required=True, type=bool, help='whether to use entropy or not') # resnets.. 1e-3, Vit..1e-4?

args = parser.parse_args()
if args.use_attention_entropy:
    ENTROPY_WEIGHT = 1.0
else:
    ENTROPY_WEIGHT = 0.0
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        if batch_idx > 50:
            ...
            ENTROPY_WEIGHT = 0.
            loss = criterion(outputs, targets) + ENTROPY_WEIGHT * ent
        loss.backward()
        optimizer.step()
